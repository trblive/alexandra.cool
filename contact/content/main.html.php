<main id="maincontent">
    <hgroup id="hgroup">
        <h1>Contact</h1>
        <p>(It's working!! Please say hello <i class="fa-regular fa-face-smile-beam"></i>)</p>
    </hgroup>
    <div id="form-content">
        ...
        <form method="post" id="theForm">
            ...
            <fieldset id="submitForm">
                <label for="terms" id="termsLabel"><input type="checkbox" name="terms" id="terms">I agree to be nice.</label>
                <div id="buttons">
        ...
        <section id="hcard-section">
            ...
            <table class="h-card">
                <thead>
                <tr>
                    <th colspan="4">Message from <span id="full-name"><span class="placeholder">You</span></span></th>
                </tr>
                </thead>
                <tbody>
                <tr class="v1row1">
