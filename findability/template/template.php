...
<html lang='en' class='light-mode'>
    <head>
        ...
        <meta name='keywords' content='findability, SEO, search engine optimisation'>
...
$header = "
        <header>
            <nav>
                ...
                <ul class='nav'>
                    <li><a href='https://alexandra.cool/findability/'>about</a></li>
...
$footer = "
        <footer>
            ...
            <p>This work is licensed under <a href='http://creativecommons.org/licenses/by-nc-sa/4.0/?ref=chooser-v1' target='_blank' rel='license noopener noreferrer'>CC BY-NC-SA 4.0</a></p>
            <p>Inspired by <a href='https://lynnandtonic.com/'>Lynn Fisher</a>.</p>
            <ul class='nav social'>
                <li><a href='mailto:hello@alexandra.cool'><i class='fa-solid fa-envelope'></i><span class='hidden'>Email</span></a></li>
                <li><a href='https://github.com/trblive'><i class='fa-brands fa-github-alt'></i><span class='hidden'>GitHub</span></a></li>
                <li><a href='https://www.linkedin.com/in/alexandra-cool/'><i class='fa-brands fa-linkedin-in'></i><span class='hidden'>LinkedIn</span></a></li>
            </ul>
